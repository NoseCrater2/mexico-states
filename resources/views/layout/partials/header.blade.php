<header class="topbar px-4 d-flex align-items-center justify-content-end">
    <div class="d-flex align-items-center gap-4">
        <button
            type="button"
            class="btn btn-link p-0 text-muted position-relative"
        ...
        <div class="d-flex align-items-center gap-2">
            <span class="d-none d-md-block fw-medium text-dark">
                Admin User
            </span>
